...
import com.xht.redis.msg.SubMsgListener;
...
public class RedisConfig {
    ...
    RedisMessageListenerContainer redisContainer(RedisConnectionFactory redisConnectionFactory){
        ...
        listenerContainer.addMessageListener(messageListenerAdapter(), new ChannelTopic("test-channel"));
